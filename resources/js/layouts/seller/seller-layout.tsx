...
import { LayoutDashboard, Package, ShoppingCart, LogOut, ExternalLink, Menu, X } from 'lucide-react';
        ...
        <div className="min-h-screen bg-background">
            ...
            <aside className={cn(
                ...
                <div className="flex h-16 items-center border-b px-6">
                    ...
                    <span className="ml-2 text-xs font-medium text-muted-foreground">Seller</span>
                </div>
